...
class Q_Agent():
    ...
    def __init__(self, environment, epsilon=0.1):
        ...
        self.epsilonGreedy = EpsilonGreedy.EpsilonGreedy(epsilon, len(self.environment.actions))

    # Returns an index of the availableActions array.
    def choose_action(self):
        return self.epsilonGreedy.select_arm()

    def update(self, arm, reward):
        self.epsilonGreedy.update(arm, reward)
