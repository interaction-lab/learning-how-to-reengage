...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 413,
    ...
    SBK_QWRITELOCKER_IDX                                     = 310,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 311,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 312,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 313,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 314,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 315,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 316,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 320,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 319,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 318,
    SBK_QXMLSTREAMREADER_IDX                                 = 317,
    SBK_QXMLSTREAMWRITER_IDX                                 = 321,
    SBK_QT_GLOBALCOLOR_IDX                                   = 356,
    SBK_QT_MOUSEBUTTON_IDX                                   = 372,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 131,
    SBK_QT_ORIENTATION_IDX                                   = 377,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 133,
    SBK_QT_FOCUSPOLICY_IDX                                   = 351,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 390,
    SBK_QT_SORTORDER_IDX                                     = 388,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 389,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 135,
    SBK_QT_TILERULE_IDX                                      = 395,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 323,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 118,
    SBK_QT_TEXTFLAG_IDX                                      = 392,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 391,
    SBK_QT_WHITESPACEMODE_IDX                                = 404,
    SBK_QT_HITTESTACCURACY_IDX                               = 358,
    SBK_QT_WINDOWTYPE_IDX                                    = 409,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 140,
    SBK_QT_WINDOWSTATE_IDX                                   = 408,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 139,
    SBK_QT_APPLICATIONSTATE_IDX                              = 326,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 119,
    SBK_QT_SCREENORIENTATION_IDX                             = 382,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 134,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 405,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 325,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 359,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 125,
    SBK_QT_BGMODE_IDX                                        = 330,
    SBK_QT_KEY_IDX                                           = 366,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 367,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 129,
    SBK_QT_MODIFIER_IDX                                      = 371,
    SBK_QT_ARROWTYPE_IDX                                     = 327,
    SBK_QT_PENSTYLE_IDX                                      = 380,
    SBK_QT_PENCAPSTYLE_IDX                                   = 378,
    SBK_QT_PENJOINSTYLE_IDX                                  = 379,
    SBK_QT_BRUSHSTYLE_IDX                                    = 331,
    SBK_QT_SIZEMODE_IDX                                      = 387,
    SBK_QT_UIEFFECT_IDX                                      = 403,
    SBK_QT_CURSORSHAPE_IDX                                   = 340,
    SBK_QT_TEXTFORMAT_IDX                                    = 393,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 328,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 343,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 120,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 344,
    SBK_QT_TOOLBARAREA_IDX                                   = 398,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 137,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 399,
    SBK_QT_DATEFORMAT_IDX                                    = 341,
    SBK_QT_TIMESPEC_IDX                                      = 396,
    SBK_QT_DAYOFWEEK_IDX                                     = 342,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 383,
    SBK_QT_CASESENSITIVITY_IDX                               = 332,
    SBK_QT_CORNER_IDX                                        = 339,
    SBK_QT_EDGE_IDX                                          = 346,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 122,
    SBK_QT_CONNECTIONTYPE_IDX                                = 336,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 385,
    SBK_QT_FILLRULE_IDX                                      = 349,
    SBK_QT_MASKMODE_IDX                                      = 369,
    SBK_QT_CLIPOPERATION_IDX                                 = 335,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 364,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 365,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 402,
    SBK_QT_AXIS_IDX                                          = 329,
    SBK_QT_FOCUSREASON_IDX                                   = 352,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 337,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 361,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 127,
    SBK_QT_INPUTMETHODHINT_IDX                               = 360,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 126,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 347,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 400,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 368,
    SBK_QT_ANCHORPOINT_IDX                                   = 324,
    SBK_QT_FINDCHILDOPTION_IDX                               = 350,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 123,
    SBK_QT_DROPACTION_IDX                                    = 345,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 121,
    SBK_QT_CHECKSTATE_IDX                                    = 333,
    SBK_QT_ITEMDATAROLE_IDX                                  = 362,
    SBK_QT_ITEMFLAG_IDX                                      = 363,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 128,
    SBK_QT_MATCHFLAG_IDX                                     = 370,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 130,
    SBK_QT_WINDOWMODALITY_IDX                                = 407,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 394,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 136,
    SBK_QT_EVENTPRIORITY_IDX                                 = 348,
    SBK_QT_SIZEHINT_IDX                                      = 386,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 406,
    SBK_QT_COORDINATESYSTEM_IDX                              = 338,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 401,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 138,
    SBK_QT_GESTURESTATE_IDX                                  = 354,
    SBK_QT_GESTURETYPE_IDX                                   = 355,
    SBK_QT_GESTUREFLAG_IDX                                   = 353,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 124,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 375,
    SBK_QT_NAVIGATIONMODE_IDX                                = 376,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 417,
    SBK_QT_TIMERTYPE_IDX                                     = 397,
    SBK_QT_SCROLLPHASE_IDX                                   = 384,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 374,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 373,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 132,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 334,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 357,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 381,
    SBK_QtCoreQT_IDX                                         = 322,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 411,
    SBK_QCBORKNOWNTAGS_IDX                                   = 29,
    SBK_QCBORSIMPLETYPE_IDX                                  = 32,
    SBK_QTMSGTYPE_IDX                                        = 412,
    SBK_QtCore_IDX_COUNT                                     = 418
};
...
enum : int {
    ...
    SBK_QPTRDIFF_IDX                                         = 10,
    SBK_QUINTPTR_IDX                                         = 11,
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 12, // QList<QXmlStreamNamespaceDeclaration >
    ...
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 26, // QList<QVariant >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 27, // QList<QItemSelectionRange >
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 28, // QList<QObject* >
    SBK_QTCORE_QLIST_QURL_IDX                                = 29, // QList<QUrl >
    ...
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 33, // QList<QCommandLineOption >
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 34, // QHash<QString,QVariant >
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 35, // QMap<QString,QVariant >
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 36, // QList<QCborValue >
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 37, // QMap<int,QVariant >
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 38, // QList<QPersistentModelIndex >
