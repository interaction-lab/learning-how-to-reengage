...
enum : int {
    ...
    SBK_QHOSTADDRESS_SPECIALADDRESS_IDX                      = 29,
    SBK_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX                  = 28,
    SBK_QFLAGS_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX           = 20,
    SBK_QHOSTADDRESS_IDX                                     = 27,
    SBK_QHOSTINFO_HOSTINFOERROR_IDX                          = 31,
    SBK_QHOSTINFO_IDX                                        = 30,
    SBK_QHSTSPOLICY_POLICYFLAG_IDX                           = 33,
    SBK_QFLAGS_QHSTSPOLICY_POLICYFLAG_IDX                    = 21,
    SBK_QHSTSPOLICY_IDX                                      = 32,
    SBK_QHTTP2CONFIGURATION_IDX                              = 34,
    SBK_QHTTPMULTIPART_CONTENTTYPE_IDX                       = 36,
    SBK_QHTTPMULTIPART_IDX                                   = 35,
    SBK_QHTTPPART_IDX                                        = 37,
    SBK_QIPV6ADDRESS_IDX                                     = 38,
    SBK_QLOCALSERVER_SOCKETOPTION_IDX                        = 40,
    SBK_QFLAGS_QLOCALSERVER_SOCKETOPTION_IDX                 = 22,
    SBK_QLOCALSERVER_IDX                                     = 39,
    SBK_QLOCALSOCKET_LOCALSOCKETERROR_IDX                    = 42,
    SBK_QLOCALSOCKET_LOCALSOCKETSTATE_IDX                    = 43,
    SBK_QLOCALSOCKET_IDX                                     = 41,
    SBK_QNETWORKACCESSMANAGER_OPERATION_IDX                  = 45,
    SBK_QNETWORKACCESSMANAGER_IDX                            = 44,
    SBK_QNETWORKADDRESSENTRY_DNSELIGIBILITYSTATUS_IDX        = 47,
    SBK_QNETWORKADDRESSENTRY_IDX                             = 46,
    SBK_QNETWORKCACHEMETADATA_IDX                            = 48,
    SBK_QNETWORKCOOKIE_RAWFORM_IDX                           = 50,
    SBK_QNETWORKCOOKIE_SAMESITE_IDX                          = 51,
    SBK_QNETWORKCOOKIE_IDX                                   = 49,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 52,
    SBK_QNETWORKDATAGRAM_IDX                                 = 53,
    SBK_QNETWORKDISKCACHE_IDX                                = 54,
    SBK_QNETWORKINFORMATION_REACHABILITY_IDX                 = 57,
    SBK_QNETWORKINFORMATION_FEATURE_IDX                      = 56,
    SBK_QFLAGS_QNETWORKINFORMATION_FEATURE_IDX               = 23,
    SBK_QNETWORKINFORMATION_IDX                              = 55,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 59,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 24,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 60,
    SBK_QNETWORKINTERFACE_IDX                                = 58,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 63,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 62,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 25,
    SBK_QNETWORKPROXY_IDX                                    = 61,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 64,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 66,
    SBK_QNETWORKPROXYQUERY_IDX                               = 65,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 68,
    SBK_QNETWORKREPLY_IDX                                    = 67,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 72,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 70,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 71,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 73,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 74,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 75,
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 76,
    SBK_QNETWORKREQUEST_IDX                                  = 69,
    SBK_QOCSPRESPONSE_IDX                                    = 78,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 80,
    SBK_QSSL_KEYTYPE_IDX                                     = 88,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 85,
    SBK_QSSL_KEYALGORITHM_IDX                                = 87,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 84,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 90,
    SBK_QSSL_SSLOPTION_IDX                                   = 89,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 26,
    SBK_QSSL_ALERTLEVEL_IDX                                  = 82,
    SBK_QSSL_ALERTTYPE_IDX                                   = 83,
    SBK_QSSL_IMPLEMENTEDCLASS_IDX                            = 86,
    SBK_QSSL_SUPPORTEDFEATURE_IDX                            = 91,
    SBK_QtNetworkQSSL_IDX                                    = 81,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 94,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 93,
    SBK_QSSLCERTIFICATE_IDX                                  = 92,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 95,
    SBK_QSSLCIPHER_IDX                                       = 96,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 98,
    SBK_QSSLCONFIGURATION_IDX                                = 97,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 100,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 99,
    SBK_QSSLELLIPTICCURVE_IDX                                = 101,
    SBK_QSSLERROR_SSLERROR_IDX                               = 103,
    SBK_QSSLERROR_IDX                                        = 102,
    SBK_QSSLKEY_IDX                                          = 104,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 105,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 108,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 107,
    SBK_QSSLSOCKET_IDX                                       = 106,
    SBK_QTCPSERVER_IDX                                       = 109,
    SBK_QTCPSOCKET_IDX                                       = 110,
    SBK_QUDPSOCKET_IDX                                       = 111,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 77,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 79,
    SBK_QtNetwork_IDX_COUNT                                  = 112
};
